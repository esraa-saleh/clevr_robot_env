...
def add_objects_grid(num_objects, min_dist, max_dist, metadata=None):
  ...
  color_mapping = [('red', '1 0.1 0.1 1'), ('blue', '0.2 0.5 1 1'),
                    ('green', '0.2 1 0 1'), ('magenta', '0.8 0.2 1 1'),
                    ('cyan', '0.2 1 1 1'), ('purple', '0.5 0.2 1 1'), ('white', '1 1 1 1'),  ('red2', '1 0.1 0.1 1'), ('blue2', '0.2 0.5 1 1'),
                    ('green2', '0.2 1 0 1'), ('magenta2', '0.8 0.2 1 1'),
                    ('cyan2', '0.2 1 1 1'), ('purple2', '0.5 0.2 1 1'), ('white2', '1 1 1 1'), ('red3', '1 0.1 0.1 1'), ('blue3', '0.2 0.5 1 1'),
                    ('green3', '0.2 1 0 1'), ('magenta3', '0.8 0.2 1 1'),
                    ('cyan3', '0.2 1 1 1'), ('purple3', '0.5 0.2 1 1'), ('white3', '1 1 1 1'), ('red4', '1 0.1 0.1 1'), ('blue4', '0.2 0.5 1 1'),
                    ('green4', '0.2 1 0 1'), ('magenta4', '0.8 0.2 1 1'),
                    ('cyan4', '0.2 1 1 1'), ('purple4', '0.5 0.2 1 1'), ('white4', '1 1 1 1'), ('red5', '1 0.1 0.1 1'), ('blue5', '0.2 0.5 1 1'),
                    ('green5', '0.2 1 0 1'), ('magenta5', '0.8 0.2 1 1'),
                    ('cyan5', '0.2 1 1 1'), ('purple5', '0.5 0.2 1 1'), ('white5', '1 1 1 1'), ('red6', '1 0.1 0.1 1'), ('blue6', '0.2 0.5 1 1'),
                    ('green6', '0.2 1 0 1'), ('magenta6', '0.8 0.2 1 1'),
                    ('cyan6', '0.2 1 1 1'), ('purple6', '0.5 0.2 1 1'), ('white6', '1 1 1 1'), ('red7', '1 0.1 0.1 1'), ('blue7', '0.2 0.5 1 1'),
                    ('green7', '0.2 1 0 1'), ('magenta7', '0.8 0.2 1 1'),
                    ('cyan7', '0.2 1 1 1'), ('purple7', '0.5 0.2 1 1'), ('white7', '1 1 1 1'), ('red8', '1 0.1 0.1 1'), ('blue8', '0.2 0.5 1 1'),
                    ('green8', '0.2 1 0 1'), ('magenta8', '0.8 0.2 1 1'),
                    ('cyan8', '0.2 1 1 1'), ('purple8', '0.5 0.2 1 1'), ('white8', '1 1 1 1'), ('red9', '1 0.1 0.1 1'), ('blue9', '0.2 0.5 1 1'),
                    ('green9', '0.2 1 0 1'), ('magenta9', '0.8 0.2 1 1'),
                    ('cyan9', '0.2 1 1 1'), ('purple9', '0.5 0.2 1 1'), ('white9', '1 1 1 1'), ('red10', '1 0.1 0.1 1'), ('blue10', '0.2 0.5 1 1'),
                    ('green10', '0.2 1 0 1'), ('magenta10', '0.8 0.2 1 1'),
                    ('cyan10', '0.2 1 1 1'), ('purple10', '0.5 0.2 1 1'), ('white10', '1 1 1 1'), ('red11', '1 0.1 0.1 1'), ('blue11', '0.2 0.5 1 1'),
                    ('green11', '0.2 1 0 1'), ('magenta11', '0.8 0.2 1 1'),
                    ('cyan11', '0.2 1 1 1'), ('purple11', '0.5 0.2 1 1'), ('white11', '1 1 1 1'), ('red12', '1 0.1 0.1 1'), ('blue12', '0.2 0.5 1 1'),
                    ('green12', '0.2 1 0 1'), ('magenta12', '0.8 0.2 1 1'),
                    ('cyan12', '0.2 1 1 1'), ('purple12', '0.5 0.2 1 1'), ('white12', '1 1 1 1'), ('red13', '1 0.1 0.1 1'), ('blue13', '0.2 0.5 1 1'),
                    ('green13', '0.2 1 0 1'), ('magenta13', '0.8 0.2 1 1'),
                    ('cyan13', '0.2 1 1 1'), ('purple13', '0.5 0.2 1 1'), ('white13', '1 1 1 1'), ('red14', '1 0.1 0.1 1'), ('blue14', '0.2 0.5 1 1'),
                    ('green14', '0.2 1 0 1'), ('magenta14', '0.8 0.2 1 1'),
                    ('cyan14', '0.2 1 1 1'), ('purple14', '0.5 0.2 1 1'), ('white14', '1 1 1 1'), ('red15', '1 0.1 0.1 1'), ('blue15', '0.2 0.5 1 1'),
                    ('green15', '0.2 1 0 1'), ('magenta15', '0.8 0.2 1 1'),
                    ('cyan15', '0.2 1 1 1'), ('purple15', '0.5 0.2 1 1'), ('white15', '1 1 1 1')
                    ]
  material_mapping = ['rubber']
  
  # Directions
  directions = [(x, y) for x in [-0.4, -0.2, 0, 0.2, 0.4] for y in [-0.4, -0.2, 0, 0.2, 0.4] if not (x == 0 and y == 0)]
...
def add_random_objects(scene_struct,
  ...
  if not metadata:
    ...
    color_mapping = [('red', '1 0.1 0.1 1'), ('blue', '0.2 0.5 1 1'),
                    ...
                    ('cyan2', '0.2 1 1 1'), ('purple2', '0.5 0.2 1 1'), ('white2', '1 1 1 1'), ('red3', '1 0.1 0.1 1'), ('blue3', '0.2 0.5 1 1'),
                    ('green3', '0.2 1 0 1'), ('magenta3', '0.8 0.2 1 1'),
                    ('cyan3', '0.2 1 1 1'), ('purple3', '0.5 0.2 1 1'), ('white3', '1 1 1 1'), ('red3', '1 0.1 0.1 1'), ('blue3', '0.2 0.5 1 1'),
                    ('green3', '0.2 1 0 1'), ('magenta3', '0.8 0.2 1 1'),
                    ('cyan3', '0.2 1 1 1'), ('purple3', '0.5 0.2 1 1'), ('white3', '1 1 1 1'), ('red4', '1 0.1 0.1 1'), ('blue4', '0.2 0.5 1 1'),
                    ('green4', '0.2 1 0 1'), ('magenta4', '0.8 0.2 1 1'),
                    ('cyan4', '0.2 1 1 1'), ('purple4', '0.5 0.2 1 1'), ('white4', '1 1 1 1'), ('red5', '1 0.1 0.1 1'), ('blue5', '0.2 0.5 1 1'),
                    ...
                    ('cyan8', '0.2 1 1 1'), ('purple8', '0.5 0.2 1 1'), ('white8', '1 1 1 1'), ('red9', '1 0.1 0.1 1'), ('blue9', '0.2 0.5 1 1'),
                    ('green9', '0.2 1 0 1'), ('magenta9', '0.8 0.2 1 1'),
                    ('cyan9', '0.2 1 1 1'), ('purple9', '0.5 0.2 1 1'), ('white9', '1 1 1 1')]
    material_mapping = ['rubber']
  else:
